...
The 7th character in the ciphertext is 0x02, and in the final decoded text it should be 0x49 (ascii code of I), so the 7th character of the key should be 0x02 XOR 0x49 which is 0x4b the ascii code of `K`
